...
[^1]: windowsの人は違う感じになると思います。Windowsの人はパスをコピーした際の区切り文字が¥か\なので気をつけてください。僕は/で統一したいのでPathcopycopyと言うソフトを入れて/で区切るパスもコピーできるようにしています。
...
そして今あなたがDesktopディレクトリにいる[^3]とします。この時にtest1.csvの相対パスはどうなるかというと
```
./test1.csv
```
...
[^3]:「いる」って何だよと思った方は鋭いですが、後で説明するので待っててください。
